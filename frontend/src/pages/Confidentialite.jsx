  ...
  return (
    <div className="min-h-screen bg-paper text-ink">
      ...
      <section className="max-w-[820px] mx-auto px-6 lg:px-12 py-16 lg:py-24" data-testid="page-confidentialite">
        ...
        <p className="eyebrow text-ink/60">Vos données, vos droits</p>
        ...
        <div className="mt-10 rounded-md border border-ink/15 bg-paper-2 p-5 flex items-start gap-3">
        ...
        <div className="mt-12 space-y-10 text-ink/85 leading-relaxed">
          <section>
            <h2 className="font-serif-display text-2xl text-ink">1. Quelles données traitons-nous ?</h2>
          ...
          <section>
            <h2 className="font-serif-display text-2xl text-ink">2. Où sont stockées vos données ?</h2>
            <p className="mt-3 text-sm">
          ...
          <section>
            <h2 className="font-serif-display text-2xl text-ink">3. Cookies et traceurs</h2>
            <p className="mt-3 text-sm">
          ...
          <section>
            <h2 className="font-serif-display text-2xl text-ink">4. Partage par lien</h2>
            <p className="mt-3 text-sm">
          ...
          <section>
            <h2 className="font-serif-display text-2xl text-ink">5. Vos droits</h2>
            <p className="mt-3 text-sm">
          ...
          <section>
            <h2 className="font-serif-display text-2xl text-ink">6. Service partenaire d'envoi en LRAR</h2>
            <p className="mt-3 text-sm">
